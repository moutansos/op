...
var openAPIDocument = []byte(`{
  ...
  "paths": {
    ...
    "/v1/projects/{id}/open": {"post": {"security": [{"bearerAuth": []}], "summary": "Open a project window", "parameters": [{"name": "id", "in": "path", "required": true, "schema": {"type": "string"}}], "requestBody": {"required": true, "content": {"application/json": {"schema": {"type": "object", "properties": {"profile": {"type": "string"}, "newInstance": {"type": "boolean"}}}}}}, "responses": {"200": {"description": "Opened"}}}},
